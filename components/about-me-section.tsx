...
export function AboutSection() {
  ...
  return (
    <SectionContainer id="about" ariaLabelledby={headingId} className="relative overflow-hidden">
      ...
      <div className="relative z-10 grid gap-8 lg:grid-cols-[minmax(0,1.45fr)_minmax(0,1fr)]">
        <div className="rounded-[2rem] border border-slate-200/80 bg-white/82 p-8 shadow-[0_20px_60px_rgba(15,23,42,0.07)] backdrop-blur-md dark:border-slate-800/80 dark:bg-[rgba(15,23,42,0.72)] md:p-10">
          ...
          <h2
            id={headingId}
            className="mt-4 text-3xl font-semibold tracking-tight text-slate-900 dark:text-slate-50 md:text-4xl"
          >
          ...
          <p className="mt-4 max-w-3xl text-sm leading-7 text-slate-600 dark:text-slate-300/90 md:text-[15px]">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div
                key={item.label}
                className="rounded-2xl border border-slate-200/80 bg-slate-50/80 p-4 dark:border-slate-800/80 dark:bg-slate-950/30"
              >
                <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">{item.label}</p>
                <p className="mt-2 text-sm leading-6 text-slate-600 dark:text-slate-300/90">{item.text}</p>
              </div>
            ))}
          </div>
          ...
          <Button
            asChild
            size="lg"
            className="mt-8 w-full rounded-full bg-slate-900 text-slate-50 hover:bg-slate-800 dark:bg-slate-50 dark:text-slate-900 sm:w-auto"
          >
        ...
        <div className="grid gap-6">
          <div className="rounded-[2rem] border border-slate-200/80 bg-white/85 p-6 shadow-[0_20px_60px_rgba(15,23,42,0.07)] backdrop-blur-md dark:border-slate-800/80 dark:bg-[rgba(15,23,42,0.72)]">
            <p className="text-xs font-semibold uppercase tracking-[0.24em] text-slate-500 dark:text-slate-400">
              Snapshot
            </p>
          ...
          <div className="h-fit self-start rounded-[2rem] border border-slate-200/80 bg-white/85 p-6 text-sm text-slate-700 shadow-[0_20px_60px_rgba(15,23,42,0.07)] backdrop-blur-md dark:border-slate-800/80 dark:bg-[rgba(15,23,42,0.72)] dark:text-slate-200">
